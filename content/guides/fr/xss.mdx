---
title: "XSS (Cross-Site Scripting) - Guide complet d'exploitation et de protection"
category: "web-security"
description: "Guide expert sur XSS : types (Reflected, Stored, DOM-based), techniques d'évasion avancées, contextes d'injection (HTML, JavaScript, CSS, URL), méthodes de protection (CSP, sanitization, encodage contextuel), exemples de code complets, outils de test et cas d'usage réels."
...
# XSS (Cross-Site Scripting) - Guide complet d'exploitation et de protection
