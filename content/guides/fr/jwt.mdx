---
title: "JSON Web Tokens (JWT) - Guide complet de sécurité"
category: "cryptography"
description: "Guide expert sur les JWT : structure détaillée, algorithmes de signature (HS256, RS256, ES256), vulnérabilités avancées (algorithm confusion, kid injection, weak secrets), implémentations sécurisées, refresh tokens, bonnes pratiques et outils de test."
...
# JSON Web Tokens (JWT) - Guide complet de sécurité
